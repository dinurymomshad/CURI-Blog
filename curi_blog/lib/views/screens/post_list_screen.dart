...
class PostList extends ConsumerWidget {
   PostList(this.categoryName);
  final String categoryName;

  @override
  Widget build(BuildContext context, ScopedReader watch) {
    final postsState = watch(postsByCategoryProvider.state);
    final scrollControllerProvider = watch(postByCategoryScrollProvider);
    return ProviderListener(
      provider: postByCategoryScrollProvider.state,
      onChange: (context, state) {
        if (state is ScrollReachedBottomState) {
          context.read(postsByCategoryProvider).getMorePostsByCategory();
        }
      },
      child: Scaffold(
                      ...
                      children: [
                                  ...
                                  loadingBuilder: (BuildContext context, Widget child, ImageChunkEvent loadingProgress) {
                                    ...
                                    return Center(
                                      child: CircularProgressIndicator(
                                        valueColor: AlwaysStoppedAnimation(KColor.categoryColor[Random().nextInt(KColor.categoryColor.length)]),
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            HtmlWidget(postsState.responseObject[index].excerpt.trim(),
                                    textStyle: KTextStyle.body2, enableCaching: true, webView: true)
                                .pOnly(bottom: 5),
                            Row(
                              children: [
